...
class LibrarySizeTest {
  ...
  def juRegexSize(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 142291,
      expectedFullLinkSize = 88251,
      classDefs,
  ...
  def unicodeData_parseInt(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 64071,
      expectedFullLinkSize = 45374,
      classDefs,
      moduleInitializers = MainTestModuleInitializers
    )
  }
  ...
  def unicodeData_parseInt_isLowerCase(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 93694,
      expectedFullLinkSize = 74250,
      classDefs,
      moduleInitializers = MainTestModuleInitializers
    )
  }
  ...
  def unicodeData_parseInt_isLowerCase_isMirrored(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 95488,
      expectedFullLinkSize = 75702,
      classDefs,
      moduleInitializers = MainTestModuleInitializers
    )
  }
