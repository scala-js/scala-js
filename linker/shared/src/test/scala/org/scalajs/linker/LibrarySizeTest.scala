...
class LibrarySizeTest {
  ...
  def juRegexSize(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 145395,
      expectedFullLinkSize = 89483,
      classDefs,
  ...
  def unicodeData_parseInt(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 66519,
      expectedFullLinkSize = 46278,
      classDefs,
      moduleInitializers = MainTestModuleInitializers
    )
  }
  ...
  def unicodeData_parseInt_isLowerCase(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 78097,
      expectedFullLinkSize = 57155,
      classDefs,
      moduleInitializers = MainTestModuleInitializers
    )
  }
  ...
  def unicodeData_parseInt_isLowerCase_isMirrored(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 79318,
      expectedFullLinkSize = 58059,
      classDefs,
      moduleInitializers = MainTestModuleInitializers
    )
  }
