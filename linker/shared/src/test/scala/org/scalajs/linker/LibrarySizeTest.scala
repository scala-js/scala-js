...
class LibrarySizeTest {
  ...
  def juRegexSize(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 143476,
      expectedFullLinkSize = 87265,
      classDefs,
  ...
  def unicodeData_parseInt(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 64913,
      expectedFullLinkSize = 44370,
      classDefs,
      moduleInitializers = MainTestModuleInitializers
    )
  }
  ...
  def unicodeData_parseInt_isLowerCase(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 94536,
      expectedFullLinkSize = 73246,
      classDefs,
      moduleInitializers = MainTestModuleInitializers
    )
  }
  ...
  def unicodeData_parseInt_isLowerCase_isMirrored(): AsyncResult = await {
    ...
    testLinkedSizes(
      expectedFastLinkSize = 96330,
      expectedFullLinkSize = 74698,
      classDefs,
      moduleInitializers = MainTestModuleInitializers
    )
  }
