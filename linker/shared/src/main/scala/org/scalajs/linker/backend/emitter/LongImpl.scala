...
private[linker] object LongImpl {
  ...
  final val divModByConstantSmallSigned = {
    MethodName("divModByConstantSmallSigned",
        List(LongRef, IntRef, BooleanRef, DoubleRef, BooleanRef), LongRef)
  }

  final val divModByConstantMediumSigned = {
    MethodName("divModByConstantMediumSigned",
        List(LongRef, IntRef, BooleanRef, DoubleRef, BooleanRef), LongRef)
  }

  final val divModByConstantLargeSigned = {
    MethodName("divModByConstantLargeSigned",
        List(LongRef, LongRef, BooleanRef, DoubleRef, BooleanRef), LongRef)
  }

  final val divModByConstantSmall =
    MethodName("divModByConstantSmall", List(LongRef, IntRef, DoubleRef, BooleanRef), LongRef)
  ...
  val AllIntrinsicMethods = Set(
    ...
    absLong,
    multiplyFull,
    divModByConstantSmallSigned,
    divModByConstantMediumSigned,
    divModByConstantLargeSigned,
