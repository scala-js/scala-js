...
trait JSDefinitions {
  ...
  class JSDefinitionsClass {
    ...
    lazy val JavaDefaultMethodAnnotation =
      getRequiredClass("scala.scalajs.js.annotation.JavaDefaultMethod")

    lazy val JSImportNamespaceObject =
      getRequiredModule("scala.scalajs.js.annotation.JSImport.Namespace")
    ...
    lazy val WasPublicBeforeTyperClass =
      getRequiredClass("scala.scalajs.js.annotation.internal.WasPublicBeforeTyper")
    ...
    lazy val Runtime_wrapJavaScriptException =
      getMemberMethod(RuntimePackageModule, newTermName("wrapJavaScriptException"))
    lazy val Runtime_unwrapJavaScriptException =
      getMemberMethod(RuntimePackageModule, newTermName("unwrapJavaScriptException"))
    ...
    lazy val Runtime_withContextualJSClassValue =
      getMemberMethod(RuntimePackageModule, newTermName("withContextualJSClassValue"))
    ...
    lazy val Runtime_identityHashCode =
      getMemberMethod(RuntimePackageModule, newTermName("identityHashCode"))
    ...
    def ScalaRunTime_isArray: Symbol =
      getMemberMethod(ScalaRunTimeModule, newTermName("isArray")).suchThat(_.tpe.params.size == 2)
    ...
    lazy val EnableReflectiveInstantiationAnnotation =
      getRequiredClass("scala.scalajs.reflect.annotation.EnableReflectiveInstantiation")
