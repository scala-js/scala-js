...
trait JSDefinitions {
  ...
  class JSDefinitionsClass {
    ...
    lazy val JavaLangReflectArrayModClass =
      getModuleIfDefined("java.lang.reflect.Array").moduleClass
    ...
    lazy val JavaScriptExceptionClass =
      getClassIfDefined("scala.scalajs.js.JavaScriptException")
    ...
    lazy val LinkTimePropertyAnnotation =
      getRequiredClass("scala.scalajs.annotation.linkTimeProperty")
    ...
    lazy val Tuple2_apply =
      getMemberMethod(TupleClass(2).companionModule, nme.apply)
    ...
    def ScalaRunTime_isArray: Symbol = getMemberMethod(ScalaRunTimeModule,
    ...
    lazy val EnableReflectiveInstantiationAnnotation = getRequiredClass(
