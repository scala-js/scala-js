...
@JSGlobal
class Promise[+A](
    executor: js.Function2[js.Function1[A | js.Thenable[A], _],
  ...
  def `then`[B >: A](
      ...
      onRejected: js.UndefOr[
          js.Function1[scala.Any, B | js.Thenable[B]]]): js.Promise[B] =
    js.native
...
object Promise extends js.Object {
  ...
  def all[A](promises: js.Iterable[js.Promise[A]]): js.Promise[js.Array[A]] =
    js.native
