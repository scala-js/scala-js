...
object Object extends js.Object {
   ...
   *  MDN
   */
  def getOwnPropertyDescriptor(o: js.Object, p: String): js.PropertyDescriptor = js.native
   ...
   *  MDN
   */
  def defineProperty(o: js.Object, p: String, attributes: js.PropertyDescriptor): o.type = js.native
  ...
  /** <span class="badge badge-ecma2017" style="float: right;">ECMAScript 2017</span>
   */
  def entries[A](dict: js.Dictionary[A]): js.Array[js.Tuple2[String, A]] = js.native
   ...
   *  MDN
   */
  def fromEntries[A](iterable: js.Iterable[js.Tuple2[String, A]]): js.Dictionary[A] = js.native
}
