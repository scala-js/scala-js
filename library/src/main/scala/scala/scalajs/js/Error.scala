 ...
 *  2021</span> An instance representing an error when several errors need to be
 ...
 *  encountered when to create an array of an illegal length with the Array
 *  constructor, or when passing bad values to the numeric methods
 *  toExponential, toFixed, or toPrecision.
 *
 *  MDN
 */
@js.native
 ...
 *
 *  A URIError is thrown when the URI handling functions are passed a malformed
 *  URI.
 *
 *  MDN
 */
