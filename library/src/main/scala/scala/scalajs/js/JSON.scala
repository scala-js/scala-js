...
object JSON extends js.Object {
   ...
   *  parsing.
   *  @param text
   *    The string to parse as JSON. See the JSON object for a description of
   *    JSON syntax.
   *  @param reviver
   *    If a function, prescribes how the value originally produced by parsing
   ...
   *    - [[Boolean]], [[Double Number]], and [[java.lang.String String]]
   *      objects are converted to the corresponding primitive values during
   ...
   *      found in an [[Array]]). In Scala.js it is undefined behavior to
   *      directly pass any of these values to stringify.
   ...
   *  @param space
   *    A String or Int that's used to insert white space into the output JSON
   *    string for readability purposes. If this is an Int, it indicates the
   *    number of space characters to use as white space; this number is capped
   *    at 10; values less than 1 indicate that no space should be used. If this
