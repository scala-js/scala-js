 ...
 *  [[TypedArray]] of unsigned 8-bit integers whose values are clamped to their
 *  max/min rather than wrapped around if they overflow.
 */
@js.native
@JSGlobal
class Uint8ClampedArray private[this] ()
  ...
  /** Creates a new Uint8ClampedArray with the same elements than the given
   *  TypedArray
   *
