...
class Date extends js.Object {
  ...
  def this(year: Int, month: Int, date: Int = 1, hours: Int = 0, minutes: Int = 0, seconds: Int = 0,
      ms: Int = 0) = this()
  ...
  def setUTCSeconds(sec: Double, ms: Double = getMilliseconds()): Unit = js.native
  ...
  def setUTCMinutes(min: Double, sec: Double = getSeconds(),
      ms: Double = getMilliseconds()): Unit = js.native
  def setHours(hours: Double, min: Double = getMinutes(), sec: Double = getSeconds(),
      ms: Double = getMilliseconds()): Unit = js.native
  def setUTCHours(hours: Double, min: Double = getMinutes(), sec: Double = getSeconds(),
      ms: Double = getMilliseconds()): Unit = js.native
...
object Date extends js.Object {
  ...
  def UTC(year: Int, month: Int, date: Int = 1, hours: Int = 0, minutes: Int = 0, seconds: Int = 0,
      ms: Int = 0): Double = js.native
