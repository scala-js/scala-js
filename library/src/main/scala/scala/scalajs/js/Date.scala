...
class Date extends js.Object {
  ...
  /** Returns the day (date) of the month (1-31) in the specified date according
   *  to universal time.
   *
   *  MDN
   */
  ...
  /** Returns the minutes (0-59) in the specified date according to universal
   *  time.
   *
   *  MDN
   */
...
object Date extends js.Object {
   ...
   *  accepts the RFC2822 / IETF date syntax (RFC2822 Section 3.3), e.g. "Mon,
   *  25 Dec 1995 13:30:00 GMT". It understands the continental US time- zone
   *  abbreviations, but for general use, use a time-zone offset, for example,
   *  "Mon, 25 Dec 1995 13:30:00 +0430" (4 hours, 30 minutes east of the
   *  Greenwich meridian). If you do not specify a time zone, the local time
