...
class PrintersTest {
  ...
  @Test def printUnaryOp(): Unit = {
    ...
    assertPrintEquals("<unwrapFromThrowable>(e)",
        UnaryOp(UnwrapFromThrowable, ref("e", ClassType(ThrowableClass, nullable = true, exact = false))))
  ...
  @Test def printBinaryOp(): Unit = {
    ...
    assertPrintEquals("isAssignableFrom(x, y)",
        BinaryOp(Class_isAssignableFrom, classVarRef, ref("y", ClassType(ClassClass, nullable = false, exact = false))))
