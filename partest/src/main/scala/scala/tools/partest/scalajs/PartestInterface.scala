...
case class PartestTask(taskDef: TaskDef, args: Array[String]) extends Task {
  ...
  private def SBTRunner(partestFingerprint: Fingerprint, eventHandler: EventHandler,
      ...
      javacCmd: File, scalacArgs: Array[String], args: Array[String], options: ScalaJSPartestOptions,
    ...
    runnerClass.getConstructors()(0).newInstance(
        partestFingerprint, eventHandler, loggers, testClassLoader, javaCmd, javacCmd, scalacArgs,
