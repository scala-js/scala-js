...
case $FULLVER in
  ...
  2.13.2)
    VER=2.13
    ;;
  2.10.3|2.10.4|2.10.5|2.10.6|2.10.7|2.11.0|2.11.1|2.11.2|2.11.4|2.11.5|2.11.6|2.11.7|2.11.8|2.11.11|2.12.0|2.12.1|2.12.2|2.12.3|2.12.4|2.12.5|2.12.6|2.12.7|2.12.8|2.12.9|2.12.10|2.13.0|2.13.1)
...
case $FULLVER in
  ...
  2.11.12)
    ...
    ;;
  2.12.11)
    REVERSI_PREOPT_EXPECTEDSIZE=715000
    REVERSI_OPT_EXPECTEDSIZE=164000
    REVERSI_PREOPT_GZ_EXPECTEDSIZE=88000
    REVERSI_OPT_GZ_EXPECTEDSIZE=38000
    ;;
  2.13.2)
    REVERSI_PREOPT_EXPECTEDSIZE=794000
    REVERSI_OPT_EXPECTEDSIZE=190000
    REVERSI_PREOPT_GZ_EXPECTEDSIZE=107000
    REVERSI_OPT_GZ_EXPECTEDSIZE=48000
    ;;
esac
