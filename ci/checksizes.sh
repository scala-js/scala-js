...
case $FULLVER in
  2.10.2)
    REVERSI_EXTDEPS_EXPECTEDSIZE=15300000
    REVERSI_SELF_EXPECTEDSIZE=58000
    REVERSI_PREOPT_EXPECTEDSIZE=1050000
    REVERSI_OPT_EXPECTEDSIZE=172000
    ;;
  2.10.3)
    REVERSI_EXTDEPS_EXPECTEDSIZE=15400000
    REVERSI_SELF_EXPECTEDSIZE=58000
    REVERSI_PREOPT_EXPECTEDSIZE=1040000
    REVERSI_OPT_EXPECTEDSIZE=171000
    ;;
  2.10.4)
    REVERSI_EXTDEPS_EXPECTEDSIZE=15400000
    REVERSI_SELF_EXPECTEDSIZE=58000
    ...
    ;;
  2.11.0)
    REVERSI_EXTDEPS_EXPECTEDSIZE=13300000
    REVERSI_SELF_EXPECTEDSIZE=58000
    REVERSI_PREOPT_EXPECTEDSIZE=1050000
    REVERSI_OPT_EXPECTEDSIZE=174000
    ;;
  2.11.1)
    REVERSI_EXTDEPS_EXPECTEDSIZE=13300000
    REVERSI_SELF_EXPECTEDSIZE=58000
