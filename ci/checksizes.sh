...
case $FULLVER in
  2.11.12)
    ...
    REVERSI_OPT_EXPECTEDSIZE=112000
    REVERSI_PREOPT_GZ_EXPECTEDSIZE=68000
    REVERSI_OPT_GZ_EXPECTEDSIZE=29000
    ;;
  2.12.8)
    REVERSI_PREOPT_EXPECTEDSIZE=595000
    REVERSI_OPT_EXPECTEDSIZE=131000
    REVERSI_PREOPT_GZ_EXPECTEDSIZE=70000
    REVERSI_OPT_GZ_EXPECTEDSIZE=30000
    ;;
  2.13.0-RC2)
    REVERSI_PREOPT_EXPECTEDSIZE=622000
    REVERSI_OPT_EXPECTEDSIZE=141000
    REVERSI_PREOPT_GZ_EXPECTEDSIZE=84000
