...
class LongViewOfSlicedAllocDirectByteBufferLittleEndianJSTest
    extends LongViewOfByteBufferTest(new SlicedAllocDirectByteBufferFactory,
...
class ReadOnlyLongViewOfSlicedAllocDirectByteBufferBigEndianJSTest
    extends ReadOnlyLongViewOfByteBufferTest(new SlicedAllocDirectByteBufferFactory,
...
class ReadOnlyLongViewOfWrappedTypedArrayByteBufferBigEndianJSTest
    extends ReadOnlyLongViewOfByteBufferTest(new WrappedTypedArrayByteBufferFactory,
        ByteOrder.BIG_ENDIAN)
...
class ReadOnlyLongViewOfAllocDirectByteBufferLittleEndianJSTest
    extends ReadOnlyLongViewOfByteBufferTest(new AllocDirectByteBufferFactory,
        ByteOrder.LITTLE_ENDIAN)
