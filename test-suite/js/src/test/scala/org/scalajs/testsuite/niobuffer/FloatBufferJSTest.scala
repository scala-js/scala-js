...
class FloatViewOfSlicedAllocDirectByteBufferLittleEndianJSTest
    extends FloatViewOfByteBufferTest(new SlicedAllocDirectByteBufferFactory,
...
class ReadOnlyFloatViewOfAllocDirectByteBufferBigEndianJSTest
    extends ReadOnlyFloatViewOfByteBufferTest(new AllocDirectByteBufferFactory,
...
class ReadOnlyFloatViewOfSlicedAllocDirectByteBufferBigEndianJSTest
    extends ReadOnlyFloatViewOfByteBufferTest(new SlicedAllocDirectByteBufferFactory,
        ByteOrder.BIG_ENDIAN)
...
class ReadOnlyFloatViewOfWrappedTypedArrayByteBufferBigEndianJSTest
    extends ReadOnlyFloatViewOfByteBufferTest(new WrappedTypedArrayByteBufferFactory,
        ByteOrder.BIG_ENDIAN)
