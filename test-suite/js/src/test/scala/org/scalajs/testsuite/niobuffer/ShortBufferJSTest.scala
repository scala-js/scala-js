...
class ShortViewOfSlicedAllocDirectByteBufferLittleEndianJSTest
    extends ShortViewOfByteBufferTest(new SlicedAllocDirectByteBufferFactory,
...
class ShortViewOfWrappedTypedArrayByteBufferLittleEndianJSTest
    extends ShortViewOfByteBufferTest(new WrappedTypedArrayByteBufferFactory,
        ByteOrder.LITTLE_ENDIAN)
...
class ReadOnlyShortViewOfAllocDirectByteBufferBigEndianJSTest
    extends ReadOnlyShortViewOfByteBufferTest(new AllocDirectByteBufferFactory,
...
class ReadOnlyShortViewOfSlicedAllocDirectByteBufferBigEndianJSTest
    extends ReadOnlyShortViewOfByteBufferTest(new SlicedAllocDirectByteBufferFactory,
        ByteOrder.BIG_ENDIAN)
...
class ReadOnlyShortViewOfWrappedTypedArrayByteBufferBigEndianJSTest
    extends ReadOnlyShortViewOfByteBufferTest(new WrappedTypedArrayByteBufferFactory,
        ByteOrder.BIG_ENDIAN)
