...
object IntegerTest extends JasmineTest {
  ...
  describe("java.lang.Integer") {
    ...
    it("should provide `numberOfTrailingZeros`") {
      ...
      expect(Integer.numberOfTrailingZeros(1)).toEqual(0)
      expect(Integer.numberOfTrailingZeros(12)).toEqual(2)
      expect(Integer.numberOfTrailingZeros(1024 + 64 + 8)).toEqual(3)
      expect(Integer.numberOfTrailingZeros(-1)).toEqual(0)
      expect(Integer.numberOfTrailingZeros(Int.MinValue)).toEqual(31)
      expect(Integer.numberOfTrailingZeros(Int.MaxValue)).toEqual(0)

      expect(Integer.numberOfTrailingZeros(1610612736)).toEqual(29)
      expect(Integer.numberOfTrailingZeros(-1610612736)).toEqual(29)
      expect(Integer.numberOfTrailingZeros(1409286144)).toEqual(26)
      expect(Integer.numberOfTrailingZeros(-2147483648)).toEqual(31)
      expect(Integer.numberOfTrailingZeros(1207959552)).toEqual(27)
      expect(Integer.numberOfTrailingZeros(-536928256)).toEqual(13)
      expect(Integer.numberOfTrailingZeros(-1096256668)).toEqual(2)
      expect(Integer.numberOfTrailingZeros(-923795456)).toEqual(20)
      expect(Integer.numberOfTrailingZeros(-1610612736)).toEqual(29)
      expect(Integer.numberOfTrailingZeros(-2077753344)).toEqual(19)
      expect(Integer.numberOfTrailingZeros(-1602224128)).toEqual(23)
      expect(Integer.numberOfTrailingZeros(-136456432)).toEqual(4)
      expect(Integer.numberOfTrailingZeros(1711399936)).toEqual(10)
      expect(Integer.numberOfTrailingZeros(467664896)).toEqual(21)
      expect(Integer.numberOfTrailingZeros(1270874112)).toEqual(22)
      expect(Integer.numberOfTrailingZeros(-1163198464)).toEqual(16)
      expect(Integer.numberOfTrailingZeros(-1830050048)).toEqual(8)
      expect(Integer.numberOfTrailingZeros(929614128)).toEqual(4)
      expect(Integer.numberOfTrailingZeros(-83886080)).toEqual(24)
      expect(Integer.numberOfTrailingZeros(-1610612736)).toEqual(29)
      expect(Integer.numberOfTrailingZeros(-2147483648)).toEqual(31)
      expect(Integer.numberOfTrailingZeros(-1549762560)).toEqual(15)
      expect(Integer.numberOfTrailingZeros(1810143104)).toEqual(7)
      expect(Integer.numberOfTrailingZeros(1398800384)).toEqual(21)
      expect(Integer.numberOfTrailingZeros(-2147483648)).toEqual(31)
      expect(Integer.numberOfTrailingZeros(-81723392)).toEqual(16)
      expect(Integer.numberOfTrailingZeros(1061913644)).toEqual(2)
      expect(Integer.numberOfTrailingZeros(-1964724608)).toEqual(7)
      expect(Integer.numberOfTrailingZeros(1995440128)).toEqual(20)
      expect(Integer.numberOfTrailingZeros(-335544320)).toEqual(26)
      expect(Integer.numberOfTrailingZeros(-1193917187)).toEqual(0)
      expect(Integer.numberOfTrailingZeros(1714683904)).toEqual(18)
      expect(Integer.numberOfTrailingZeros(-2147483648)).toEqual(31)
      expect(Integer.numberOfTrailingZeros(1003175936)).toEqual(14)
      expect(Integer.numberOfTrailingZeros(-2147483648)).toEqual(31)
      expect(Integer.numberOfTrailingZeros(1610612736)).toEqual(29)
      expect(Integer.numberOfTrailingZeros(-1946157056)).toEqual(26)
      expect(Integer.numberOfTrailingZeros(-1907228672)).toEqual(17)
      expect(Integer.numberOfTrailingZeros(-268435456)).toEqual(28)
      expect(Integer.numberOfTrailingZeros(-1535911424)).toEqual(9)
      expect(Integer.numberOfTrailingZeros(523888512)).toEqual(7)
      expect(Integer.numberOfTrailingZeros(358260320)).toEqual(5)
      expect(Integer.numberOfTrailingZeros(981467136)).toEqual(23)
      expect(Integer.numberOfTrailingZeros(1669332992)).toEqual(23)
      expect(Integer.numberOfTrailingZeros(-1207959552)).toEqual(27)
      expect(Integer.numberOfTrailingZeros(536870912)).toEqual(29)
      expect(Integer.numberOfTrailingZeros(-748945408)).toEqual(18)
      expect(Integer.numberOfTrailingZeros(1289338880)).toEqual(14)
      expect(Integer.numberOfTrailingZeros(-82051072)).toEqual(18)
      expect(Integer.numberOfTrailingZeros(-2147483648)).toEqual(31)
      expect(Integer.numberOfTrailingZeros(-675172352)).toEqual(12)
      expect(Integer.numberOfTrailingZeros(77234176)).toEqual(15)
      expect(Integer.numberOfTrailingZeros(-276596511)).toEqual(0)
      expect(Integer.numberOfTrailingZeros(222966496)).toEqual(5)
      expect(Integer.numberOfTrailingZeros(-1981260992)).toEqual(6)
      expect(Integer.numberOfTrailingZeros(1689927680)).toEqual(14)
      expect(Integer.numberOfTrailingZeros(-2147483648)).toEqual(31)
      expect(Integer.numberOfTrailingZeros(-1499141888)).toEqual(8)
      expect(Integer.numberOfTrailingZeros(1441572168)).toEqual(3)
      expect(Integer.numberOfTrailingZeros(-1073741824)).toEqual(30)
      expect(Integer.numberOfTrailingZeros(-1175759872)).toEqual(10)
      expect(Integer.numberOfTrailingZeros(781713408)).toEqual(19)
      expect(Integer.numberOfTrailingZeros(1073741824)).toEqual(30)
      expect(Integer.numberOfTrailingZeros(117264512)).toEqual(7)
      expect(Integer.numberOfTrailingZeros(-808865046)).toEqual(1)
      expect(Integer.numberOfTrailingZeros(-394264576)).toEqual(23)
      expect(Integer.numberOfTrailingZeros(-1946157056)).toEqual(26)
      expect(Integer.numberOfTrailingZeros(-1619001344)).toEqual(23)
      expect(Integer.numberOfTrailingZeros(-1236860928)).toEqual(16)
      expect(Integer.numberOfTrailingZeros(-134639968)).toEqual(5)
      expect(Integer.numberOfTrailingZeros(-1946157056)).toEqual(26)
      expect(Integer.numberOfTrailingZeros(-1342177280)).toEqual(28)
      expect(Integer.numberOfTrailingZeros(1610612736)).toEqual(29)
      expect(Integer.numberOfTrailingZeros(1879048192)).toEqual(28)
      expect(Integer.numberOfTrailingZeros(-1073741824)).toEqual(30)
      expect(Integer.numberOfTrailingZeros(1994391552)).toEqual(21)
      expect(Integer.numberOfTrailingZeros(-1862270976)).toEqual(24)
      expect(Integer.numberOfTrailingZeros(-2055471104)).toEqual(18)
      expect(Integer.numberOfTrailingZeros(349175808)).toEqual(20)
      expect(Integer.numberOfTrailingZeros(-1247477760)).toEqual(16)
      expect(Integer.numberOfTrailingZeros(-1874415616)).toEqual(12)
      expect(Integer.numberOfTrailingZeros(1336606720)).toEqual(16)
      expect(Integer.numberOfTrailingZeros(565581745)).toEqual(0)
      expect(Integer.numberOfTrailingZeros(-2147483648)).toEqual(31)
      expect(Integer.numberOfTrailingZeros(562036736)).toEqual(23)
      expect(Integer.numberOfTrailingZeros(1372687704)).toEqual(3)
      expect(Integer.numberOfTrailingZeros(1147437056)).toEqual(15)
      expect(Integer.numberOfTrailingZeros(941499392)).toEqual(10)
      expect(Integer.numberOfTrailingZeros(938859008)).toEqual(9)
      expect(Integer.numberOfTrailingZeros(1987222364)).toEqual(2)
      expect(Integer.numberOfTrailingZeros(251658240)).toEqual(24)
      expect(Integer.numberOfTrailingZeros(1598124120)).toEqual(3)
      expect(Integer.numberOfTrailingZeros(-1177763840)).toEqual(14)
      expect(Integer.numberOfTrailingZeros(1879048192)).toEqual(28)
      expect(Integer.numberOfTrailingZeros(-939524096)).toEqual(27)
      expect(Integer.numberOfTrailingZeros(-622854144)).toEqual(21)
      expect(Integer.numberOfTrailingZeros(-1577058304)).toEqual(25)
      expect(Integer.numberOfTrailingZeros(1751711744)).toEqual(16)
      expect(Integer.numberOfTrailingZeros(-1392508928)).toEqual(24)
      expect(Integer.numberOfTrailingZeros(303562752)).toEqual(19)
    }
