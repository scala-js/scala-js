...
class RandomGeneratorTest {
  ...
  @Test def testNextFloatWithBound(): Unit = {
    ...
    assertExactEquals(
        88902.516f, make(0xb85927b9d6e3249bL).nextFloat(123456.789f))
    assertExactEquals(7.0590034f, make(0x0bf3df8c2f645e7dL).nextFloat(151.189f))
    assertExactEquals(
        0.0f, make(0x857f63be5f2f9ca0L).nextFloat(Float.MinPositiveValue))
    assertExactEquals(
        2.1418906e38f, make(0xa12351957679f21fL).nextFloat(Float.MaxValue))
    ...
    assertThrows(classOf[IllegalArgumentException], make().nextFloat(-0.0f))
    assertThrows(
        classOf[IllegalArgumentException], make().nextFloat(Float.MinValue))
  ...
  @Test def testNextFloatWithOriginAndBound(): Unit = {
    ...
    assertExactEquals(
        -10.63579f, make(0x4dd3ce2b9e4f98d3L).nextFloat(-15.5f, 0.5f))
    assertExactEquals(
        745774.4f, make(0xb85927b9d6e3249bL).nextFloat(123456.789f, 987654.321f))
    assertExactEquals(
        -561941.4f, make(0x0bf3df8c2f645e7dL).nextFloat(-589456.0f, -151.189f))
    assertExactEquals(
        123.456f, make(0x857f63be5f2f9ca0L).nextFloat(123.456f, 123.45601f)) // 1 ulp of difference
    ...
    if (!executingInJVMOnLowerThanJDK(19)) {
      ...
      assertExactEquals(-5.4696933e37f,
          make(0xa12351957679f21fL).nextFloat(MinValue, MaxValue / 3.0f))
      assertExactEquals(
          8.809577e37f, make(0xa12351957679f21fL).nextFloat(MinValue, MaxValue))
      assertExactEquals(1.7215796e38f,
          make(0xa12351957679f21fL).nextFloat(MinValue / 3.0f, MaxValue))

      assertExactEquals(5.684898e37f,
          make(0xe01389542264f955L).nextFloat(MinValue, MaxValue / 3.0f))
      assertExactEquals(
          2.5541462e38f, make(0xe01389542264f955L).nextFloat(MinValue, MaxValue))
      assertExactEquals(2.8370388e38f,
          make(0xe01389542264f955L).nextFloat(MinValue / 3.0f, MaxValue))

      assertExactEquals(-3.0610379e38f,
          make(0x1348eac1e0b1d30dL).nextFloat(MinValue, MaxValue / 3.0f))
      assertExactEquals(
          -2.890145e38f, make(0x1348eac1e0b1d30dL).nextFloat(MinValue, MaxValue))
      assertExactEquals(-7.9248886e37f,
    ...
    assertThrows(
        classOf[IllegalArgumentException], make().nextFloat(-10.0f, -10.0f))
    ...
    assertThrows(
        classOf[IllegalArgumentException], make().nextFloat(Float.NaN, 0.0f))
    assertThrows(
        classOf[IllegalArgumentException], make().nextFloat(0.0f, Float.NaN))
  }
  ...
  @Test def testNextDoubleWithBound(): Unit = {
    assertExactEquals(
        0.8046754253236388, make(0xcdff356ba8f073c7L).nextDouble(1.0))
    assertExactEquals(
        0.15200657160235592, make(0x4dd3ce2b9e4f98d3L).nextDouble(0.5))
    assertExactEquals(
        88902.51771898914, make(0xb85927b9d6e3249bL).nextDouble(123456.789))
    assertExactEquals(
        7.059008395303237, make(0x0bf3df8c2f645e7dL).nextDouble(151.189))
    assertExactEquals(
        0.0, make(0x857f63be5f2f9ca0L).nextDouble(Double.MinPositiveValue))
    assertExactEquals(1.1315492615876175e308,
    ...
    assertThrows(classOf[IllegalArgumentException], make().nextDouble(-0.0))
    assertThrows(
        classOf[IllegalArgumentException], make().nextDouble(Double.MinValue))
    assertThrows(classOf[IllegalArgumentException],
  ...
  @Test def testNextDoubleWithOriginAndBound(): Unit = {
    assertExactEquals(
        0.9023377126618194, make(0xcdff356ba8f073c7L).nextDouble(0.5, 1.0))
    assertExactEquals(
        -10.63578970872461, make(0x4dd3ce2b9e4f98d3L).nextDouble(-15.5, 0.5))
    assertExactEquals(745774.4195139175,
        make(0xb85927b9d6e3249bL).nextDouble(123456.789, 987654.321))
    assertExactEquals(-561941.381818508,
        make(0x0bf3df8c2f645e7dL).nextDouble(-589456.0, -151.189))
    assertExactEquals(123.456,
        make(0x857f63be5f2f9ca0L).nextDouble(123.456, 123.45600000000002)) // 1 ulp of diff
    ...
    assertExactEquals(Double.MinPositiveValue,
        make(0L).nextDouble(
            Double.MinPositiveValue, 1024 * Double.MinPositiveValue))

    assertThrows(
        classOf[IllegalArgumentException], make().nextDouble(-10.0, -10.0))
    ...
    assertThrows(
        classOf[IllegalArgumentException], make().nextDouble(Double.NaN, 0.0))
    assertThrows(
        classOf[IllegalArgumentException], make().nextDouble(0.0, Double.NaN))
  }
  ...
  @Test def testNextIntWithOriginAndBound(): Unit = {
    ...
    assertEquals(
        529406464, make(0x4dd3ce2b9e4f98d3L).nextInt(-123456789, 987654321))
    assertEquals(
        -453574692, make(0xb85927b9d6e3249bL).nextInt(-2000000000, -123456789))
    ...
    // Rejects one sample
    assertEquals(47233791,
        make(0xff5c1abdc835a88dL, 0x7cd709fed6fc0e33L).nextInt(
            -1000000000, 1000000000))

    // bound - origin overflows
    assertEquals(
        1165941437, make(0x457edabdccfc99b3L).nextInt(-1000000000, 2000000000))

    // bound - origin overflows and rejects one sample
    assertEquals(112541956,
        make(0x77fa600cd5741c70L, 0x06b54104f821ddfeL).nextInt(
            -1000000000, 2000000000))

    // Powers of 2 have a dedicated path
    assertEquals(45, make(0x457edabdccfc99b3L).nextInt(40, 40 + 8))
    assertEquals(-999999058,
        make(0x867f0bae045cc0b5L).nextInt(-1000000000, -1000000000 + 1024))
    assertEquals(
        420090567, make(0xd9110b1c6a647a80L).nextInt(-456789, -456789 + (1 << 30)))

    // The power of 2 that also overflows
    assertEquals(
        670157577, make(0x27f8c35e876aa500L).nextInt(-456789, -456789 + (1 << 31)))
  ...
  @Test def testNextLongWithBound(): Unit = {
    ...
    assertEquals(
        6567945330301L, make(0x4dd3ce2b9e4f98d3L).nextLong(9876543219876L))
    assertEquals(2641846127516815949L,
    ...
    assertEquals(
        5805606983335475471L, make(0xa12351957679f21fL).nextLong(Long.MaxValue))
    ...
    assertEquals(
        3459984693225774508L, make(0x700455bf2802ddacL).nextLong(1L << 62))
  ...
  @Test def testNextLongWithOriginAndBound(): Unit = {
    ...
    assertEquals(
        694809301731568007L, make(0x1348eac1e0b1d30dL).nextLong(1, Long.MaxValue))
    ...
    assertEquals(861277746941419133L,
        make(0x0bf3df8c2f645e7dL).nextLong(
    ...
    assertEquals(-999999819L,
        make(0x867f0bae045cc0b5L).nextLong(-1000000000L, -1000000000 + 1024L))
    assertEquals(710771243L,
        make(0xd9110b1c6a647a80L).nextLong(-456789L, -456789L + (1L << 30)))
    assertEquals(2000214810766255360L,
        make(0x27f8c35e876aa500L).nextLong(
            2000000000000000000L, 2000000000000000000L + (1L << 50)))
    assertEquals(3459983458657883274L,
        make(0x700455bf2802ddacL).nextLong(
            -1234567891234L, -1234567891234L + (1L << 62)))

    // The power of 2 that also overflows
    assertEquals(4556382677778913777L,
        make(0xbf3b87070bbc6313L).nextLong(
            -1234567891234L, -1234567891234L + (1L << 63)))
