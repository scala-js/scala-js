...
class FloatTest {
  ...
  @Test def froundForSpecialValues(): Unit = {
    ...
    assertEquals(
        Double.PositiveInfinity, 1 / froundNotInlined(0.0).toDouble, 0.0)
    assertEquals(
        Double.NegativeInfinity, 1 / froundNotInlined(-0.0).toDouble, 0.0)
    assertEquals(
        Float.PositiveInfinity, froundNotInlined(Double.PositiveInfinity), 0.0)
    assertEquals(
        Float.NegativeInfinity, froundNotInlined(Double.NegativeInfinity), 0.0)
  }
  ...
  @Test def froundUnderflows(): Unit = {
    assertEquals(
        Double.PositiveInfinity, 1 / froundNotInlined(1e-300).toDouble, 0.0)
    assertEquals(
        Double.NegativeInfinity, 1 / froundNotInlined(-1e-300).toDouble, 0.0)
  }
