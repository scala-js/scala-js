...
class CharacterUnicodeBlockTest {
  ...
  @Test def forNameNormalizations(): Unit = {
    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.forName("Surrogates-Area"))
    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.forName("Surrogates Area"))
    assertThrows(
        classOf[IllegalArgumentException], UnicodeBlock.forName("SurrogatesArea"))
    assertEquals(
        UnicodeBlock.SURROGATES_AREA, UnicodeBlock.forName("SURROGATES_AREA"))
    ...
    assertThrows(
        classOf[IllegalArgumentException], UnicodeBlock.forName("Basic Lat iN"))
    assertThrows(
        classOf[IllegalArgumentException], UnicodeBlock.forName("Basic Lat in"))
    assertThrows(
        classOf[IllegalArgumentException], UnicodeBlock.forName("Basic-Latin"))

    assertEquals(
        UnicodeBlock.ARABIC_EXTENDED_A, UnicodeBlock.forName("Arabic Extended-A"))
    assertEquals(
        UnicodeBlock.ARABIC_EXTENDED_A, UnicodeBlock.forName("ARABIC EXTENDED-A"))
    assertEquals(
        UnicodeBlock.ARABIC_EXTENDED_A, UnicodeBlock.forName("Arabic_Extended_A"))
    assertEquals(
        UnicodeBlock.ARABIC_EXTENDED_A, UnicodeBlock.forName("ARABIC_EXTENDED_A"))
    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.forName("Arabic Extended_A"))
    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.forName("Arabic_Extended-A"))
    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.forName("Arabic_ExtendedA"))
    assertEquals(
        UnicodeBlock.ARABIC_EXTENDED_A, UnicodeBlock.forName("ArabicExtended-A"))
    assertEquals(
        UnicodeBlock.ARABIC_EXTENDED_A, UnicodeBlock.forName("ARABICEXTENDED-A"))
    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.forName("Arabic ExtendedA"))
    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.forName("Arabic_ExtendedA"))
    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.forName("ArabicExtendedA"))
  ...
  @Test def forNameHistorical(): Unit = {
    ...
    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.forName("GREEK_AND_COPTIC"))
    ...
    assertEquals(UnicodeBlock.COMBINING_MARKS_FOR_SYMBOLS,
        UnicodeBlock.forName("COMBINING_MARKS_FOR_SYMBOLS"))
    assertEquals(UnicodeBlock.COMBINING_MARKS_FOR_SYMBOLS,
        UnicodeBlock.forName("Combining Marks for Symbols"))
    assertEquals(UnicodeBlock.COMBINING_MARKS_FOR_SYMBOLS,
        UnicodeBlock.forName("CombiningMarksforSymbols"))

    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.forName("CYRILLIC_SUPPLEMENT"))
    assertEquals(UnicodeBlock.CYRILLIC_SUPPLEMENTARY,
        UnicodeBlock.forName("Cyrillic Supplement"))
    assertEquals(UnicodeBlock.CYRILLIC_SUPPLEMENTARY,
        UnicodeBlock.forName("CyrillicSupplement"))
    assertEquals(UnicodeBlock.CYRILLIC_SUPPLEMENTARY,
        UnicodeBlock.forName("CYRILLIC_SUPPLEMENTARY"))
    assertEquals(UnicodeBlock.CYRILLIC_SUPPLEMENTARY,
        UnicodeBlock.forName("Cyrillic Supplementary"))
    assertEquals(UnicodeBlock.CYRILLIC_SUPPLEMENTARY,
        UnicodeBlock.forName("CyrillicSupplementary"))
    // scalastyle:on line.size.limit
  }

  @Test def ofIntOutOfRangeThrowsIllegalArgumentException(): Unit = {
    assertThrows(classOf[IllegalArgumentException],
        UnicodeBlock.of(Character.MAX_CODE_POINT + 1))
  }

  @Test def forNameNotFoundThrowsIllegalArgumentException(): Unit = {
    assertThrows(
        classOf[IllegalArgumentException], UnicodeBlock.forName("INVALID_NAME"))
  }
  ...
  @Test def ofChar(): Unit = {
    ...
    assertEquals(
        UnicodeBlock.MEETEI_MAYEK_EXTENSIONS, UnicodeBlock.of(0xaae0.toChar))
    assertEquals(
        UnicodeBlock.MEETEI_MAYEK_EXTENSIONS, UnicodeBlock.of(0xaaff.toChar))
  ...
  @Test def ofCodePoint(): Unit = {
    ...
    assertEquals(
        UnicodeBlock.ANCIENT_GREEK_MUSICAL_NOTATION, UnicodeBlock.of(0x1d200))
    assertEquals(
        UnicodeBlock.ANCIENT_GREEK_MUSICAL_NOTATION, UnicodeBlock.of(0x1d24f))
    assertEquals(
        UnicodeBlock.SUPPLEMENTARY_PRIVATE_USE_AREA_B, UnicodeBlock.of(0x100000))
    assertEquals(
        UnicodeBlock.SUPPLEMENTARY_PRIVATE_USE_AREA_B, UnicodeBlock.of(0x10ffff))
  }
  ...
  @Test def forNameString(): Unit = {
    ...
    assertEquals(UnicodeBlock.MEETEI_MAYEK_EXTENSIONS,
        UnicodeBlock.forName("MEETEI_MAYEK_EXTENSIONS"))
    assertEquals(UnicodeBlock.MEETEI_MAYEK_EXTENSIONS,
        UnicodeBlock.forName("Meetei Mayek Extensions"))
    assertEquals(UnicodeBlock.MEETEI_MAYEK_EXTENSIONS,
        UnicodeBlock.forName("MeeteiMayekExtensions"))
    assertEquals(UnicodeBlock.SPECIALS, UnicodeBlock.forName("SPECIALS"))
    assertEquals(UnicodeBlock.SPECIALS, UnicodeBlock.forName("Specials"))

    assertEquals(UnicodeBlock.LINEAR_B_SYLLABARY,
        UnicodeBlock.forName("LINEAR_B_SYLLABARY"))
    assertEquals(UnicodeBlock.LINEAR_B_SYLLABARY,
        UnicodeBlock.forName("Linear B Syllabary"))
    assertEquals(
        UnicodeBlock.LINEAR_B_SYLLABARY, UnicodeBlock.forName("LinearBSyllabary"))
