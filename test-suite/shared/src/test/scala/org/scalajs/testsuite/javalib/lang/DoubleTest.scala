...
class DoubleTest {
  ...
  @Test def parseStringMethods(): Unit = {
    ...
    test("0x3bcc9c4f57.f9a4f7c38944030572c19c235c9c7fa195p4351",
        Double.PositiveInfinity)
    test("0x5a5e28727048d5fc7a412e24b8d43eb896e97aa35cd3.63511582434bd029b800daf1a050abb7de2p882",
        Double.PositiveInfinity)
    test("0x29087f7ee0bd6aad502b60de6dfd8793.43f94d82f523d1752400e968cap1",
        1.090849442407432e38)
    test("0x.c22e399bp45", 2.6687973842944e13)
    test("0x79b19c420.p-714", 3.790455421249137e-205)
    test(
        "0xb0ce07bedeccdee4ea23651efe67375c.dfee4d87p510", 7.877552996709097e191)
    test("0xc1bde6a227c610729.18838356d2d80db2bf863b3f8b861faf4p5",
        7.147810818070931e21)
    ...
    test("0xcfd63cf55ba4baae14e00.e25e0e6ad14d0079590d8f3d4a23757ae2dp-41",
        7.141220395741147e12)
    ...
    test("0x62263ea3ba241e0bdce84d7d6936861c81.00927d354639e8360ee01edp2",
        1.3359403146110964e41)
    test("0x49002fa5938.b54da0c70b9e77ef171e402d359ec72cp39",
        2.7578894924960133e24)
    ...
    test(
        "0x3af268e735192f7a3733.90798aa580d3d6504053df967e554760938ea85823eadp9",
        1.425248906962734e26)
    test("0xa2368682d42e4408e1.7706c0e74aeaba33a0baff87e22e3acd191211e2f9f59p-4738",
        0.0)
    ...
    test("0xc3be28219dcc00557aaaae8c056e7416f0ed13db4.9e9cb950p-790",
        2.745797751832513e-189)
    ...
    test("0x0112e744ac19b8a158c4712d39f5ae9ff254f9dab9082.67b1e05b429ec492fc873p2628",
        Double.PositiveInfinity)
    test("0x4124a6dc2f89206034099fcad671552f78e6.21351c7e6e8582c60285ap8",
        1.452741259747921e45)
    ...
    test("0xbf476a9c79896b2d0cddd0fdeb8d965e4c56c0348802611f5.6c53c3p-5",
        2.3450733549226435e57)
    test("0xc59f164c0ee8495143225ce5.268820f13cp3680", Double.PositiveInfinity)
    test("0x6d1eaee6d1e5c0251f1885371.764d29da90690a9b78bc45edbp-441",
        9.515580739963098e-104)
    ...
    test("0x36beea0aa7cc593a23f47ecd401b38fc5b9bd4ed2.6c14d1c991f72p7",
        6.400881277193871e50)
    test("0xbafc02016adba217f7d5e10fe938ca2a96bb4e26a38eb8b6.25p0",
        4.584844284745914e57)
    test("0xe0.76e5af7fb57213c8be7796434496p00", 224.46444222324266)
    test(
        "0x6b7334ad12263.90c9a635c2c8208b942fc1913199cp3", 1.5122246293590812e16)
    ...
    test("0xef7007bab0a3eea.61e7119bd29653a81c31ef1e263d1b9p9",
        5.521055574676869e20)
    test("0xdbce4587c9c.b77b2c4d92daacd9e393dc98f6bp-0", 1.5104936017052717e13)
    test("0xfbbc30cf74818.2fd1f12cc035c03dfca5830d50164cb79b868c87p8",
        1.13371419166953267e18)
    test("0x149bf7.787b98fd06ee25d8e270518ep-6", 21103.866728686717)
    test("0xca2f5e9d6b2f7a391417fc49583eabe7ac309.54f03855fd29b1ef1a0p86",
        2.180359130716814e70)
    ...
    test("0xe0afae54cbd689d3e1068.a5ce3ead8c8e9ca3d1c10365da3afeab99dc4f39p-74",
        898.7450153341871)
    ...
    test("0x7657db92eaaa.92902feb89bc1a352e52b917c3b7cfe4dp5",
        4.1638309782705465e15)
    test("0x575c272512a00bd2f8d1a14f280d0987f7c53e12d21.f30p-9",
        3.989898204914359e48)
    test("0x30398ddf709b895ce4.1b0ca907d7a1a69061b8c6abcp-86",
        1.149769331391146e-5)
    ...
    test("0xbed724343613.8746f2f7edf13abf35ea02ae381bfd433758f9d8015deee07p-2",
        5.245780866189288e13)
    test("0x753dde30cf11b0073.f95e0330b0353fd9219d602ccf6p-93",
        1.364872693205332e-8)
    test("0x0a005b9d1e9b0c8c461900ed564d93c8.5fp8072", Double.PositiveInfinity)
    test("0x09fff743267.22ffa43ca933345fd786cd8196cf9e82fb7c49dd5599b5fdp104",
        1.3937779918868934e43)
    ...
    test("0xb904b6c4f518c7.dc2e488212f140253073da2180b7e6b74d6336p-754",
        5.495889783734122e-211)
    test("0x99826bcb8bfd8a22e0765ee7fcefd57e3.798eefea2dbdadp-44",
        1.8558154651252258e26)
    test("0xdaa946f53a4e18b6d1b07190aca94ad13374d5134.631e65342f4d6bdc9p-4930",
        0.0)
    test("0xf15fbca5010a4249d98c5137f214d3d.458d525617f62001db6f2p68",
        5.918472578157268e57)
    test("0x052cdde16bb8e7a6265046639.a2f897e77aa1a5d03fa5dap-759",
        8.451331130505346e-201)
    ...
    test("0x8698b81c9c16e5a8decab9b6d.b028dc31b3952b24068e3d34e7ca98eb83ccp82",
        3.2229472965243904e54)
    test("0x662c64a84437ed9cdf306b8a5ffba3ff030c814761ac.037c61e9ad5bec868efp-745",
        2.0655247050064035e-172)
    test("0xe882d86a9deee6.a63cf9e373467af776ec826bc3800p016",
        4.2890730281470667e21)
