...
abstract class ShortBufferTest extends BaseBufferTest {
  ...
  class ByteBufferShortViewFactory(byteBufferFactory: BufferFactory.ByteBufferFactory,
      order: ByteOrder)
...
abstract class ShortViewOfByteBufferTest(byteBufferFactory: BufferFactory.ByteBufferFactory,
    order: ByteOrder)
...
abstract class ReadOnlyShortViewOfByteBufferTest(byteBufferFactory: BufferFactory.ByteBufferFactory,
    order: ByteOrder)
    extends ShortBufferTest {
