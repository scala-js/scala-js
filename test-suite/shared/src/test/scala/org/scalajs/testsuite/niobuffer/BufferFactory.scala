...
sealed abstract class BufferFactory {
  ...
  implicit def bufferAdapter(buffer: BufferType): BufferAdapter[BufferType, ElementType]
  ...
  def withContent(pos: Int, limit: Int, capacity: Int, content: ElementType*): BufferType = {
...
object BufferFactory {
  ...
  trait WrappedBufferFactory extends BufferFactory {
    ...
    protected def baseWrap(array: Array[ElementType], offset: Int, length: Int): BufferType
