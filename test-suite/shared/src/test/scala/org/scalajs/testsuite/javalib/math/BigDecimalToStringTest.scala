...
class BigDecimalToStringTest {
  ...
  @Test def testToStringWithCornerCaseScales(): Unit = {
    ...
    assertEquals(
        "1E+2147483647", new BigDecimal(bigIntOne, -2147483647).toString())
    assertEquals(
        "1E+2147483648", new BigDecimal(bigIntOne, -2147483648).toString()) // #4088
    ...
    assertEquals(
        "1.23E-2147483645", new BigDecimal(bigInt123, 2147483647).toString())
    ...
    assertEquals(
        "1.23E+2147483649", new BigDecimal(bigInt123, -2147483647).toString()) // #4088
    assertEquals(
        "1.23E+2147483650", new BigDecimal(bigInt123, -2147483648).toString()) // #4088
  }
