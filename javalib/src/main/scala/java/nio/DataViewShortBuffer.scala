...
private[nio] final class DataViewShortBuffer private (override private[nio] val _dataView: DataView,
...
private[nio] object DataViewShortBuffer {
  private[nio] implicit object NewDataViewShortBuffer
    ...
    def apply(dataView: DataView, initialPosition: Int, initialLimit: Int, readOnly: Boolean,
      ...
      new DataViewShortBuffer(dataView, initialPosition, initialLimit, readOnly, isBigEndian)
    }
  }
