...
private[nio] final class DataViewDoubleBuffer private (
    override private[nio] val _dataView: DataView, _initialPosition: Int, _initialLimit: Int,
...
private[nio] object DataViewDoubleBuffer {
  private[nio] implicit object NewDataViewDoubleBuffer
    ...
    def apply(dataView: DataView, initialPosition: Int, initialLimit: Int, readOnly: Boolean,
      ...
      new DataViewDoubleBuffer(dataView, initialPosition, initialLimit, readOnly, isBigEndian)
    }
  }
