...
private[nio] final class DataViewFloatBuffer private (override private[nio] val _dataView: DataView,
...
private[nio] object DataViewFloatBuffer {
  private[nio] implicit object NewDataViewFloatBuffer
    ...
    def apply(dataView: DataView, initialPosition: Int, initialLimit: Int, readOnly: Boolean,
      ...
      new DataViewFloatBuffer(dataView, initialPosition, initialLimit, readOnly, isBigEndian)
    }
  }
