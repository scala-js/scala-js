 ...
 */
private[charset] abstract class ISO_8859_1_And_US_ASCII_Common protected (name: String,
    aliases: Array[String], private val maxValue: Int)
  ...
  private class Decoder extends CharsetDecoder(ISO_8859_1_And_US_ASCII_Common.this, 1.0f, 1.0f) {
  ...
  private class Encoder extends CharsetEncoder(ISO_8859_1_And_US_ASCII_Common.this, 1.0f, 1.0f) {
