...
private[nio] final class HeapShortBuffer private (_capacity: Int, _array0: Array[Short],
...
private[nio] object HeapShortBuffer {
  private[nio] implicit object NewHeapShortBuffer
    ...
    def apply(capacity: Int, array: Array[Short], arrayOffset: Int, initialPosition: Int,
        initialLimit: Int, readOnly: Boolean): ShortBuffer = {
      new HeapShortBuffer(capacity, array, arrayOffset, initialPosition, initialLimit, readOnly)
    }
  }

  @noinline
  private[nio] def wrap(array: Array[Short], arrayOffset: Int, capacity: Int, initialPosition: Int,
      initialLength: Int, isReadOnly: Boolean): ShortBuffer = {
