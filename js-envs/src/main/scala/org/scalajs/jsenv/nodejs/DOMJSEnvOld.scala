...
//    )
//
//    protected def initWithJSDOMContext(code: VirtualJSFile): Seq[VirtualJSFile] = Seq(
//      new MemVirtualJSFile("initWithJSDOMContextStart.js").withContent(
//          s"""
//          |(function () {
...
//          |      console.log("jsdom.onload()");
//          |      console.log("$$: " + global.window.$$);
//          |
//          |      console.log("__ScalaJSEnv: " + global.__ScalaJSEnv);
//          |      console.log("__ScalaJSEnv keys: " + Object.keys(global.__ScalaJSEnv));
//          |      console.log("global keys: " + Object.keys(global));
//          |      require("/Users/nastucki/GitHub/scala-js/examples/testing/target/scala-2.11/testing-test-fastopt.js");
//          |      console.log("require ");
//          |      console.log("__ScalaJSEnv keys: " + Object.keys(global.__ScalaJSEnv));
//          |      console.log("global keys: " + Object.keys(global));
//          """.stripMargin),
//              code,
//      new MemVirtualJSFile("initWithJSDOMContextEnd.js").withContent(
//          """
//          |    }
//          |  });
//          |})();
...
//        lib.name == "jquery.js" // || lib.name == "jasmine.js" || lib.name == "jasmine-polyfills.js"
//
//      initFiles() ++
//      customInitFiles() ++
...
//      classpath.jsLibs.map(requireLibrary) //:+ classpath.scalaJSCode
//    }
//
...
//    protected override def getJSFiles(): Seq[VirtualJSFile] =
//      getLibJSFiles() ++ initWithJSDOMContext(code) //:+ code
//
//    // Send code to Stdin
