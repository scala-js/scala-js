...
object RuntimeLong {
  ...
  def divModByConstantSmall(a: Long, absB: Int, bIsNeg: Boolean,
    ...
    val absR = unsignedDivModByConstantSmall(abs(a), absB, mHat, askQuotient)
  ...
  def divModByConstantMedium(a: Long, absB: Int, bIsNeg: Boolean,
      mHat: Double, askQuotient: Boolean): Long = {
    val absR = unsignedDivModByConstantMedium(abs(a), absB, mHat, askQuotient)
    maybeNegateDivModResult(a, bIsNeg, askQuotient, absR)
  }
  ...
  def divModByConstantLarge(a: Long, absB: Long, bIsNeg: Boolean,
      mHat: Double, askQuotient: Boolean): Long = {
    val absR = unsignedDivModByConstantLarge(abs(a), absB, mHat, askQuotient)
    maybeNegateDivModResult(a, bIsNeg, askQuotient, absR)
  }

  @inline
  private def maybeNegateDivModResult(a: Long, bIsNeg: Boolean,
  ...
  /** Unsigned division by a small constant, `0 < b < 2^18`.
   *
   *  See the JS Long paper, Algorithm 8.
   */
  @inline
  def unsignedDivModByConstantSmall(a: Long, b: Int, mHat: Double, askQuotient: Boolean): Long = {
    val alo = a.toInt
    val ahi = (a >>> 32).toInt
  ...
  /** Unsigned division by a medium constant, `2^18 <= b < 2^31`.
   *
   *  See the JS Long paper, Algorithm 9, with the 32-bit remainder improvement.
   */
  @inline
  def unsignedDivModByConstantMedium(a: Long, b: Int, mHat: Double, askQuotient: Boolean): Long = {
  ...
  /** Unsigned division by a large constant, `2^31 <= b < 2^63`.
   *
   *  See the JS Long paper, Algorithm 9.
   */
  @inline
  def unsignedDivModByConstantLarge(a: Long, b: Long, mHat: Double, askQuotient: Boolean): Long = {
    val aHat = unsignedToDoubleApprox(a)
    val qHat = fromUnsignedSafeDouble(aHat * mHat)
    val rHat = a - b * qHat
  ...
  /** Unsigned division by a huge constant, `2^63 <= b < 2^64`. */
  @inline
  def unsignedDivModByConstantHuge(a: Long, b: Long, askQuotient: Boolean): Long =
    divModHuge(a, b, askQuotient)

  @inline
  private def divModHuge(a: Long, b: Long, askQuotient: Boolean): Long = {
    if (ltu(a, b)) {
      if (askQuotient) 0L
      else a
    } else {
