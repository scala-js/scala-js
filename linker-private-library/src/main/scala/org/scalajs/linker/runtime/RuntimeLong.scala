...
object RuntimeLong {
  ...
  private def toUnsignedString(lo: Int, hi: Int): String = {
    ...
    if (isUnsignedSafeDouble(hi)) {
       ...
       * approxNum. This is an approximation. It can lose as many as 11
       * low-order bits. Hence |approxNum - num| <= 2^12.
       *
       ...
       *
       * That means that the approximated quotient is at most 1 unit away from
       ...
       * If approxRem >= 10^9, correct by them +1 and -10^9, respectively.
       *
